...
function ContactUs() {
    return (
        <div className='px-24 flex gap-10 relative xl:flex-nowrap md:flex-wrap sm:flex-wrap '>
            <div>
        ...
        <div style={{"box-shadow": "0px 10px 40px 0px #8552E51A"}} className='flex justify-center items-center flex-col bg-white h-[665px] w-[553px] relative z-10 left-8 rounded-xl'>
          ...
          <form action="submit" className='px-12 py-3'>
            ...
            <div className='mb-4'>
              ...
              <input placeholder='E-mail' type="text" name="" id="" className='placeholder:pl-5 w-[323px] h-11 rounded-xl focus:outline-[#635AE3] bg-transparent border' />
            </div>
            <div className='mb-4'>
              <label className='block font-normal text-sm tracking-wide w-11 mb-2'>Contact<span className='text-red-500'>*</span></label>
              <input placeholder='Contact' type="number" name="" id="" className='placeholder:pl-5 w-[323px] h-11 rounded-xl focus:outline-[#635AE3] bg-transparent border' />
            </div>
            <div className='mb-4'>
              <label className='block font-normal text-sm tracking-wide w-11 mb-2'>Date<span className='text-red-500'>*</span></label>
              <input type="date" name="" id="" className='placeholder:pl-5 w-[323px]  h-11 rounded-xl focus:outline-[#635AE3] bg-transparent border' />
            </div>
          </form>
